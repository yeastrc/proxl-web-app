...
public class SearchDAO_Importer {
	...
	private static final Logger log = LoggerFactory.getLogger( SearchDAO_Importer.class);
	...
	private static final String INSERT_SQL =
			"INSERT INTO search "
			+ " (path, directory_name, fasta_filename, has_scan_data, has_isotope_label, status_id, created_by_user_id ) "
