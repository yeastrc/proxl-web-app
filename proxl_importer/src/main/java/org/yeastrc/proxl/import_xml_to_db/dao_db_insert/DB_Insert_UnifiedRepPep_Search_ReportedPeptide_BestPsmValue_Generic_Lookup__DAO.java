...
public class DB_Insert_UnifiedRepPep_Search_ReportedPeptide_BestPsmValue_Generic_Lookup__DAO {
	...
	private static final Logger log = Logger.getLogger(DB_Insert_UnifiedRepPep_Search_ReportedPeptide_BestPsmValue_Generic_Lookup__DAO.class);
	 ...
	 * @throws Exception
	 */
	public void saveToDatabase( UnifiedRepPep_Search_ReportedPeptide_BestPsmValue_Generic_Lookup__DTO item ) throws Exception {
...
//			}
	 ...
	 * @throws Exception
	 */
	public void saveToDatabase( UnifiedRepPep_Search_ReportedPeptide_BestPsmValue_Generic_Lookup__DTO item, Connection conn ) throws Exception {
		...
		try {
			...
			if ( linkType == XLinkUtils.TYPE_MONOLINK ) {
				...
				String msg = "Invalid to insert unified_rp__search__rep_pept__best_psm_value_generic_lookup with type Monolink, UnifiedReportedPeptideId: " + item.getUnifiedReportedPeptideId();
			...
			counter++;
			pstmt.setInt( counter, item.getPsmIdForBestValue() );
