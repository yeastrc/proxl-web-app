 ...
 *
 */
public class RunImporterToImporterParameterNamesConstants {

	

	/**
	 * For when the Run Importer program launches the Importer.
	 * A file is used to pass all the parameters, instead of being on the command line.
	 * 
	 */
