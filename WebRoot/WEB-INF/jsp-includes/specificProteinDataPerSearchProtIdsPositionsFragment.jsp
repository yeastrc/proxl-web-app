...
<%-- specificProteinDataPerSearchProtIdsPositionsFragment.jsp --%>

	<%--  Single Protein Data Item for Specific search id and protein id(s) and position(s)  Table Template --%>
