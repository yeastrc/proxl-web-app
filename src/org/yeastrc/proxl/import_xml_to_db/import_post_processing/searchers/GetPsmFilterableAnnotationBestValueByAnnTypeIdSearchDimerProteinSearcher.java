 ...
 */
public class GetPsmFilterableAnnotationBestValueByAnnTypeIdSearchDimerProteinSearcher {
	
	private static final Logger log = Logger.getLogger(GetPsmFilterableAnnotationBestValueByAnnTypeIdSearchDimerProteinSearcher.class);
	
	private GetPsmFilterableAnnotationBestValueByAnnTypeIdSearchDimerProteinSearcher() { }
	private static final GetPsmFilterableAnnotationBestValueByAnnTypeIdSearchDimerProteinSearcher _INSTANCE = new GetPsmFilterableAnnotationBestValueByAnnTypeIdSearchDimerProteinSearcher();
	public static GetPsmFilterableAnnotationBestValueByAnnTypeIdSearchDimerProteinSearcher getInstance() { return _INSTANCE; }
	
	

	/**
	 * Get "best" value from psm_annotation for annotation_type_id, searchDimerGenericLookupDTO
	 * 
...
//		}
		...
		final String sql = 
				...
				+ "(value_double) AS value_double FROM psm_filterable_annotation__generic_lookup " 
						+ " INNER JOIN dimer ON dimer.psm_id "
