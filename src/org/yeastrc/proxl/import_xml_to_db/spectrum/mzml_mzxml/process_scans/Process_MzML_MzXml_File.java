...
import org.yeastrc.proxl.import_xml_to_db.spectrum.database_update_with_transaction_services.InsertNewScanAndPrescanIfNeededDBTransactionService;
...
public class Process_MzML_MzXml_File {
	 ...
	 * @throws Exception
	 */
	public void processMzMLFile( File scanFileWithPath ) throws Exception {
		
		processMzMLFileWithScanNumbersToLoad( scanFileWithPath, null );
	}
	 ...
	 * @throws Exception
	 */
	public Map<Integer,Integer> processMzMLFileWithScanNumbersToLoad( File scanFileWithPath, int[] scanNumbersToLoad ) throws Exception {
...
//			scanFileDTO.setPath( scanFilePath );
			...
			try {
				...
				newScanFileRecord =
						AddNewScanFileAndHeadersIfNeededDBTransactionService.getInstance().addNewScanFileAndHeadersDBTransactionService( scanFileDTO, scanFileHeaderDTOList );
			...
			if ( newScanFileRecord ) {
				...
				System.out.println( "Importing MzMl or MzXml file for the first time:  " + scanFileWithPath.getAbsolutePath() );
