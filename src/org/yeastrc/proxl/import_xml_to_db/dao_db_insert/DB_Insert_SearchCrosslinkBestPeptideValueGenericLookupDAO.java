 ...
 *
 */
public class DB_Insert_SearchCrosslinkBestPeptideValueGenericLookupDAO {


	private static final Logger log = Logger.getLogger(DB_Insert_SearchCrosslinkBestPeptideValueGenericLookupDAO.class);

	private DB_Insert_SearchCrosslinkBestPeptideValueGenericLookupDAO() { }
	public static DB_Insert_SearchCrosslinkBestPeptideValueGenericLookupDAO getInstance() { return new DB_Insert_SearchCrosslinkBestPeptideValueGenericLookupDAO(); }
	 ...
	 * @throws Exception
	 */
	public void save( SearchCrosslinkBestPeptideValueGenericLookupDTO item ) throws Exception {
		
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;

		String sql = "INSERT INTO search_crosslink_best_peptide_value_generic_lookup "
