 ...
 *
 */
public class DB_Insert_SearchDimerGenericLookupDAO {

	private static final Logger log = Logger.getLogger(DB_Insert_SearchDimerGenericLookupDAO.class);

	private DB_Insert_SearchDimerGenericLookupDAO() { }
	public static DB_Insert_SearchDimerGenericLookupDAO getInstance() { return new DB_Insert_SearchDimerGenericLookupDAO(); }
	 ...
	 * @throws Exception
	 */
	public void save( SearchDimerGenericLookupDTO item ) throws Exception {
		
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		
		String sql = "INSERT INTO search_dimer_generic_lookup "

				+ " ( search_id, nrseq_id_1, nrseq_id_2, "
