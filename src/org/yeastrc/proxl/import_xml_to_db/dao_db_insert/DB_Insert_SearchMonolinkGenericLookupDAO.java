 ...
 *
 */
public class DB_Insert_SearchMonolinkGenericLookupDAO {


	private static final Logger log = Logger.getLogger(DB_Insert_SearchMonolinkGenericLookupDAO.class);

	private DB_Insert_SearchMonolinkGenericLookupDAO() { }
	public static DB_Insert_SearchMonolinkGenericLookupDAO getInstance() { return new DB_Insert_SearchMonolinkGenericLookupDAO(); }
	 ...
	 * @throws Exception
	 */
	public void save( SearchMonolinkGenericLookupDTO item ) throws Exception {
		
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		
		String sql = "INSERT INTO search_monolink_generic_lookup "

				+ " ( search_id, nrseq_id, protein_position, "
