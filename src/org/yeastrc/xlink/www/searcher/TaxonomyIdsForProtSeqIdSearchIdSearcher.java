...
public class TaxonomyIdsForProtSeqIdSearchIdSearcher {
	...
	//  search_protein_sequence_annotation ( search_id, protein_sequence_id, annotation_id 
	
	//  INSERT INTO annotation ( name, description, taxonomy 
	 ...
	 * @throws Exception
	 */
	public Set<Integer> getTaxonomyIdsSingleSearch( ProteinSequenceObject proteinSequenceObject, int searchId ) throws Exception {
		...
		try {
			...
			pstmt.setInt( 2, proteinSequenceObject.getProteinSequenceId() );
