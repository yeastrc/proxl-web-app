...
//			+ "ORDER BY nrseq_id, protein_position_1, protein_position_2";
	...
	private final String SQL_FIRST_PART = 
			...
			+ " subquery_result.protein_position_1, "
			+ " subquery_result.protein_position_2, "
...
//			+ " SUM( subquery_result.num_unique_peptides_linked_at_default_cutoff ) AS num_unique_peptides_linked_at_default_cutoff "
	...
	private final String SQL_LAST_PART = 
		  ...
		  " ) AS subquery_result  GROUP BY nrseq_id, protein_position_1, protein_position_2 ";
		

	private final String SQL_EACH_UNION_FIRST_PART_PART = 
			

			"SELECT search_looplink_generic_lookup.search_id,"
...
//					+ " search_looplink_generic_lookup.num_unique_peptides_linked_at_default_cutoff "
	 ...
	 * @throws Exception
	 */
	public List<MergedSearchProteinLooplink> search( Collection<SearchDTO> searchesParam, SearcherCutoffValuesRootLevel searcherCutoffValuesRootLevel ) throws Exception {
