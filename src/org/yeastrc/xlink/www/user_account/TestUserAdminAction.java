...
/**
 * Basic action to determine if a user is an admin user
 *
 */
public class TestUserAdminAction extends Action {

	private static final Logger log = Logger.getLogger(TestUserAdminAction.class);
