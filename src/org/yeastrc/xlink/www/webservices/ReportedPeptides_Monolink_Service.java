...
//			UserSessionObject userSessionObject = accessAndSetupWebSessionResult.getUserSessionObject();
	...
	/**
	 * @param searchPeptideMonolinkList
	 * @param searchId
	...
	private GetMonolinkReportedPeptidesServiceResult getAnnotationDataAndSort(
		...
		for ( SearchPeptideMonolinkAnnDataWrapper searchPeptideMonolinkWrappedItem : searchPeptideMonolinkWrappedList ) {
		
			SearchPeptideMonolink searchPeptideMonolinkItem = searchPeptideMonolinkWrappedItem.getSearchPeptideMonolink();
			
			int reportedPeptideId = searchPeptideMonolinkItem.getReportedPeptide().getId();
			...
			searchPeptideMonolinkWrappedItem.setPeptideAnnotationDTOMap( peptideAnnotationDTOMap );
		...
		Collections.sort( searchPeptideMonolinkWrappedList, new Comparator<SearchPeptideMonolinkAnnDataWrapper>() {

			@Override
			public int compare(SearchPeptideMonolinkAnnDataWrapper o1, SearchPeptideMonolinkAnnDataWrapper o2) {
				...
				try {
					return o1.getSearchPeptideMonolink().getReportedPeptide().getId() - o2.getSearchPeptideMonolink().getReportedPeptide().getId();
				} catch (Exception e) {
...

			{
				...
				for ( AnnotationTypeDTO annotationTypeDTO : psmCutoffsAnnotationTypeDTOList ) {
					...
					AnnotationDataBaseDTO psmAnnotationDTO = 
							searchPeptideMonolinkWrapped.getPsmAnnotationDTOMap().get( annotationTypeDTO.getId() );
				...
				searchPeptideMonolinkWebserviceResult.setPsmAnnotationValueList( psmAnnotationValues );
			}
		...
		getMonolinkReportedPeptidesServiceResult.setPeptideAnnotationDisplayNameDescriptionList( peptideAnnotationDisplayNameDescriptionList );
		getMonolinkReportedPeptidesServiceResult.setPsmAnnotationDisplayNameDescriptionList( psmAnnotationDisplayNameDescriptionList );
