...
import org.yeastrc.xlink.www.searcher.SearchReportedPeptideNrseqPositionLooplinkSearcher;
...
public class LooplinkLinkedPositions {
	...
	public List<SearchProteinLooplinkWrapper> getSearchProteinLooplinkWrapperList( SearchDTO search, SearcherCutoffValuesSearchLevel searcherCutoffValuesSearchLevel ) throws Exception {
		...
		SearchReportedPeptideNrseqPositionLooplinkSearcher searchReportedPeptideNrseqPositionSearcher =
				SearchReportedPeptideNrseqPositionLooplinkSearcher.getInstance();
		...
		for ( WebReportedPeptideWrapper wrappedPeptidelink : wrappedPeptidelinks ) {
			...
			List<SrchRepPeptNrseqIdPosLooplinkDTO> srchRepPeptNrseqIdPosLooplinkDTOList = searchReportedPeptideNrseqPositionSearcher.getSrchRepPeptNrseqIdPosLooplinkDTOList( searchId, reportedPeptideId );
			
			for ( SrchRepPeptNrseqIdPosLooplinkDTO srchRepPeptNrseqIdPosLooplinkDTO : srchRepPeptNrseqIdPosLooplinkDTOList ) {
				...
				Map<Integer,Map<Integer,RepPept_Stage_1_Wrapper>> repPept_Stage_1_Wrapper_MappedPos1Pos2 =
						repPept_Stage_1_Wrapper_MappedProtPos1Pos2.get( srchRepPeptNrseqIdPosLooplinkDTO.getNrseqId() );

				if ( repPept_Stage_1_Wrapper_MappedPos1Pos2 == null ) {

					repPept_Stage_1_Wrapper_MappedPos1Pos2 = new HashMap<>();
					repPept_Stage_1_Wrapper_MappedProtPos1Pos2.put( srchRepPeptNrseqIdPosLooplinkDTO.getNrseqId(), repPept_Stage_1_Wrapper_MappedPos1Pos2 );
				}

				
				
				Map<Integer,RepPept_Stage_1_Wrapper> repPept_Stage_1_Wrapper_MappedPos2 =
						repPept_Stage_1_Wrapper_MappedPos1Pos2.get( srchRepPeptNrseqIdPosLooplinkDTO.getNrseqPosition_1() );

				if ( repPept_Stage_1_Wrapper_MappedPos2 == null ) {

					repPept_Stage_1_Wrapper_MappedPos2 = new HashMap<>();
					repPept_Stage_1_Wrapper_MappedPos1Pos2.put( srchRepPeptNrseqIdPosLooplinkDTO.getNrseqPosition_1(), repPept_Stage_1_Wrapper_MappedPos2 );
				}


				RepPept_Stage_1_Wrapper repPept_Stage_1_Wrapper = repPept_Stage_1_Wrapper_MappedPos2.get( srchRepPeptNrseqIdPosLooplinkDTO.getNrseqPosition_2() );

				if ( repPept_Stage_1_Wrapper == null ) {

					repPept_Stage_1_Wrapper = new RepPept_Stage_1_Wrapper();
					repPept_Stage_1_Wrapper_MappedPos2.put( srchRepPeptNrseqIdPosLooplinkDTO.getNrseqPosition_2(), repPept_Stage_1_Wrapper );
				}
