 ...
 *
 */
public class SearchCrosslinkGenericLookupDAO {

	private static final Logger log = Logger.getLogger(SearchCrosslinkGenericLookupDAO.class);
			
	private SearchCrosslinkGenericLookupDAO() { }
	public static SearchCrosslinkGenericLookupDAO getInstance() { return new SearchCrosslinkGenericLookupDAO(); }
