 ...
 *
 */
public class SearchMonolinkGenericLookupDAO {

	private static final Logger log = Logger.getLogger(SearchMonolinkGenericLookupDAO.class);
			
	private SearchMonolinkGenericLookupDAO() { }
	public static SearchMonolinkGenericLookupDAO getInstance() { return new SearchMonolinkGenericLookupDAO(); }
