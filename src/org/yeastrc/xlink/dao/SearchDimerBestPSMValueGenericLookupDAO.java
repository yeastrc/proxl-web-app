 ...
 *
 */
public class SearchDimerBestPSMValueGenericLookupDAO {

	private static final Logger log = Logger.getLogger(SearchDimerBestPSMValueGenericLookupDAO.class);
			
	private SearchDimerBestPSMValueGenericLookupDAO() { }
	public static SearchDimerBestPSMValueGenericLookupDAO getInstance() { return new SearchDimerBestPSMValueGenericLookupDAO(); }
