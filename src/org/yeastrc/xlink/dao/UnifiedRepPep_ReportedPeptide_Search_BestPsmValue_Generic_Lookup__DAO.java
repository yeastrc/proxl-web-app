 ...
 *
 */
public class UnifiedRepPep_ReportedPeptide_Search_BestPsmValue_Generic_Lookup__DAO {
	
	private static final Logger log = Logger.getLogger(UnifiedRepPep_ReportedPeptide_Search_BestPsmValue_Generic_Lookup__DAO.class);

	private UnifiedRepPep_ReportedPeptide_Search_BestPsmValue_Generic_Lookup__DAO() { }
	public static UnifiedRepPep_ReportedPeptide_Search_BestPsmValue_Generic_Lookup__DAO getInstance() { return new UnifiedRepPep_ReportedPeptide_Search_BestPsmValue_Generic_Lookup__DAO(); }
