 ...
 *
 */
public class SearchCrosslinkBestPSMValueGenericLookupDAO {

	private static final Logger log = Logger.getLogger(SearchCrosslinkBestPSMValueGenericLookupDAO.class);
			
	private SearchCrosslinkBestPSMValueGenericLookupDAO() { }
	public static SearchCrosslinkBestPSMValueGenericLookupDAO getInstance() { return new SearchCrosslinkBestPSMValueGenericLookupDAO(); }
