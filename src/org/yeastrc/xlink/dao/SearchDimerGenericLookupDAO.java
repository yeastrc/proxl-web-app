 ...
 *
 */
public class SearchDimerGenericLookupDAO {

	private static final Logger log = Logger.getLogger(SearchDimerGenericLookupDAO.class);
			
	private SearchDimerGenericLookupDAO() { }
	public static SearchDimerGenericLookupDAO getInstance() { return new SearchDimerGenericLookupDAO(); }
