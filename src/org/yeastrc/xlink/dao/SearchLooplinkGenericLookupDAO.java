 ...
 *
 */
public class SearchLooplinkGenericLookupDAO {

	private static final Logger log = Logger.getLogger(SearchLooplinkGenericLookupDAO.class);
			
	private SearchLooplinkGenericLookupDAO() { }
	public static SearchLooplinkGenericLookupDAO getInstance() { return new SearchLooplinkGenericLookupDAO(); }
