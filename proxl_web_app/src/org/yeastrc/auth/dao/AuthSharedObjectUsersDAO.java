...
public class AuthSharedObjectUsersDAO {
	...
	public AuthSharedObjectUsersDTO getAuthSharedObjectUsersDTOForSharedObjectIdAndUserId( int sharedObjectId, int userId ) throws Exception {
		...
		final String sql = "SELECT * " 
				+ " FROM auth_shared_object_users WHERE shared_object_id = ? AND user_id = ? ";
...
//	 * @throws Exception
//	 */
//	public List<AuthSharedObjectUsersDTO> getListForSharedObjectIdAndPublicAccessCodeEnabled( int sharedObjectId ) throws Exception {
//		
//		AuthSharedObjectUsersDTO returnItem = null;
//		
//		Connection conn = null;
...
//
//		final String sql = "SELECT * " 
//				+ " FROM auth_shared_object_users WHERE shared_object_id = ? AND public_access_code_enabled = 1 ";
//		
//		
//		//CREATE TABLE IF NOT EXISTS auth_shared_object_users (
////		  shared_object_id INT UNSIGNED NOT NULL,
...
//		} catch ( Exception e ) {
//			
//			String msg = "getListForSharedObjectIdAndPublicAccessCodeEnabled(...): Failed to select AuthSharedObjectUsersDTO, sharedObjectId: " + sharedObjectId
//					+ ", sql: " + sql;
//			
//			log.error( msg, e );
//			
