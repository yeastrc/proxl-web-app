...
public class PPM_Error_Histogram_For_PSMPeptideCutoffs_CachedResultManager implements CachedDataInFileMgmtRegistrationIF {
	 ...
	 * @throws Exception
	 */
	public PPM_Error_Histogram_For_PSMPeptideCutoffs_CachedResultManager_Result retrieveDataFromCache( int searchId, String requestQueryString ) throws Exception {
