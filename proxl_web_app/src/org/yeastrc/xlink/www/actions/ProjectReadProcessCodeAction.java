...
public class ProjectReadProcessCodeAction extends Action {
	...
	private static final Logger log = Logger.getLogger(ProjectReadProcessCodeAction.class);
	...
	public ActionForward execute( ActionMapping mapping,
		...
		//  New query parameter WebConstants.PARAMETER_REDIRECT_AFTER_PROCESS_PROJECT_READ_CODE
		//  processing added below
