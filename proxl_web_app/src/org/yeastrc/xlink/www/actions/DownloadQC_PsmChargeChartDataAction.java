...
public class DownloadQC_PsmChargeChartDataAction extends Action {
	...
	private static final Logger log = Logger.getLogger(DownloadQC_PsmChargeChartDataAction.class);
...
//			Collections.sort( searchIds );
			...
			try {
				...
				ChargeStateCounts_Merged_Results chargeStateCounts_Merged_Results =
						ChargeStateCounts_Merged.getInstance().getChargeStateCounts_Merged( form.getQueryJSON(), searches );
