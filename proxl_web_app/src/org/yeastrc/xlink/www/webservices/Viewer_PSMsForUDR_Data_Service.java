...
public class Viewer_PSMsForUDR_Data_Service {
	...
	throws Exception {
		...
		return getViewerDataInternal( searchIds, protSeqId_1, prot_1_position, protSeqId_2, prot_2_position, request );
	...
	throws Exception {
		...
		return getViewerDataInternal( searchIds, protSeqId_1, prot_1_position, null /* protSeqId_2 */, prot_2_position, request);
...
//				SearchDTO search = SearchDAO.getInstance().getSearch( searchId );
				...
				//  Get peptides for these parameters
					reportedPeptideList = 
							...
							.searchOnSearchProteinLooplink( searchId, searcherCutoffValuesSearchLevel, protSeqId_1, prot_1_position, prot_2_position );
				}
