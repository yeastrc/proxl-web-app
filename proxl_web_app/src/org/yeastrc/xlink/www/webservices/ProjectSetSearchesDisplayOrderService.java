...
public class ProjectSetSearchesDisplayOrderService {
	...
	public ProjectSetSearchesDisplayOrderResult setSearchesOrder( ProjectSetSearchesDisplayOrderRequest projectSetSearchesOrderRequest,
		...
		try {
			...
			int[] searchesInOrder = projectSetSearchesOrderRequest.searchesInOrder;

			if ( searchesInOrder == null ) {
			...
			for( int searchId : searchesInOrder ) {
				...
				if ( projectId == null ) {
					...
					if ( projectId != search.getProjectId() ) {
						...
						String msg = "Searches don't all have the same project id, search_id: " + search.getId();
			...
			.updateSearchDisplayOrder( searchesInOrder );
