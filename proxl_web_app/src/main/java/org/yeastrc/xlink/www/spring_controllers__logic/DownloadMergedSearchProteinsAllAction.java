...
import org.yeastrc.xlink.www.spring_controllers__helpers.ProteinsAllMergedCommonPageDownload;
...
import org.yeastrc.xlink.www.spring_controllers__helpers.ProteinsAllMergedCommonPageDownload.AllProteinsMergedCommonPageDownloadResult;
import org.yeastrc.xlink.www.spring_controllers__helpers.ProteinsAllMergedCommonPageDownload.MergedProteinSingleEntry;
 ...
 *
 */
public class DownloadMergedSearchProteinsAllAction {
	
	private static final Logger log = LoggerFactory.getLogger( DownloadMergedSearchProteinsAllAction.class);
	
	public String execute( MergedSearchViewProteinsForm form, HttpServletRequest request, HttpServletResponse response )
					  throws Exception {
		try {
			// our form
