 ...
 */
public class DownloadQC_PeptideLengthChartDataAction {
	
	private static final Logger log = LoggerFactory.getLogger( DownloadQC_PeptideLengthChartDataAction.class);
