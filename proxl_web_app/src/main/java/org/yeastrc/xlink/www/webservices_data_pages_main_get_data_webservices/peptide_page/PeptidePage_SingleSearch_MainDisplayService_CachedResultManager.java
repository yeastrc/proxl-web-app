...
/**
 * 
 * Manage Cached results for PeptidePage_SingleSearch_MainDisplayService
 * 
 ...
 * Singleton
 */
public class PeptidePage_SingleSearch_MainDisplayService_CachedResultManager implements CachedDataInFileMgmtRegistrationIF {

	private static final Logger log = LoggerFactory.getLogger(  PeptidePage_SingleSearch_MainDisplayService_CachedResultManager.class );
	
	private static final String PREFIX_FOR_CACHING = "PeptidePage_SingleSearch_MainDisplayService_";

	static final int VERSION_FOR_CACHING_FROM_MAIN_CLASS = PeptidePage_SingleSearch_MainDisplayService.VERSION_FOR_CACHING;
	
	
	private static final PeptidePage_SingleSearch_MainDisplayService_CachedResultManager instance = new PeptidePage_SingleSearch_MainDisplayService_CachedResultManager();

	// private constructor
	private PeptidePage_SingleSearch_MainDisplayService_CachedResultManager() {}

	/**
	 * @return Singleton instance
	 */
	public static PeptidePage_SingleSearch_MainDisplayService_CachedResultManager getSingletonInstance() {
		return instance;
	}
	
	public static class PeptidePage_SingleSearch_MainDisplayService_CachedResultManager_Result {
	 ...
	 * @throws Exception
	 */
	public PeptidePage_SingleSearch_MainDisplayService_CachedResultManager_Result retrieveDataFromCache( 
		...
		PeptidePage_SingleSearch_MainDisplayService_CachedResultManager_Result result = new PeptidePage_SingleSearch_MainDisplayService_CachedResultManager_Result();
