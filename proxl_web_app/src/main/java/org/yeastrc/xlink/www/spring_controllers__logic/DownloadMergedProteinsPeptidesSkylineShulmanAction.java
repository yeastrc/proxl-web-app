...
import org.yeastrc.xlink.www.spring_controllers__helpers.DownloadPSMs_Common;
 ...
 *
 */
public class DownloadMergedProteinsPeptidesSkylineShulmanAction {

	private static final Logger log = LoggerFactory.getLogger( DownloadMergedSearchProteinsAction.class);

	public String execute( DownloadMergedSearchViewProteinsForm form, HttpServletRequest request, HttpServletResponse response )
					throws Exception {
