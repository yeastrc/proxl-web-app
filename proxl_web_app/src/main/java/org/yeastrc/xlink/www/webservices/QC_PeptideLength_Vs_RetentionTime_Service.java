...
@Path("/qc/dataPage")
public class QC_PeptideLength_Vs_RetentionTime_Service {

	private static final Logger log = Logger.getLogger(QC_PeptideLength_Vs_RetentionTime_Service.class);
	...
	@Path("/peptideLengthVsRetentionTime") 
	...
	throws Exception {
		...
		int projectSearchId = projectSearchIdList.get( 0 );  //  Only 1
...
//			UserSessionObject userSessionObject = accessAndSetupWebSessionResult.getUserSessionObject();
			...
			PeptideLength_Vs_RT_ScatterPlot_For_PSMPeptideCutoffs_Method_Response peptideLength_Vs_RT_ScatterPlot_For_PSMPeptideCutoffs_Method_Response =
					...
					.getPeptideLength_Vs_RT_ScatterPlot_For_PSMPeptideCutoffs(
							PeptideLength_Vs_RT_ScatterPlot_For_PSMPeptideCutoffs.ForDownload.NO, 
			...
			PeptideLength_Vs_RT_ScatterPlot_For_PSMPeptideCutoffsResults peptideLength_Vs_RT_ScatterPlot_For_PSMPeptideCutoffsResults =
					peptideLength_Vs_RT_ScatterPlot_For_PSMPeptideCutoffs_Method_Response.getPeptideLength_Vs_RT_ScatterPlot_For_PSMPeptideCutoffsResults();

			//  Get  for cutoffs and other data
			WebserviceResult serviceResult = new WebserviceResult();
			
			serviceResult.peptideLength_Vs_RT_ScatterPlot_For_PSMPeptideCutoffsResults = peptideLength_Vs_RT_ScatterPlot_For_PSMPeptideCutoffsResults;
