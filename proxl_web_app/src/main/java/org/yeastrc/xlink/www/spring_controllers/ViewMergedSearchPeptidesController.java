...
/**
 * Spring MVC controller for path /mergedPeptide.do
 */
@Controller
public class ViewMergedSearchPeptidesController {

	private static final Logger log = LoggerFactory.getLogger( ViewMergedSearchPeptidesController.class );

	@RequestMapping( A__SpringMVC_Controller_Paths.ViewMergedSearchPeptidesController_mergedPeptide )
	public String mergedPeptide(
			@ModelAttribute( "mergedSearchViewPeptideForm" ) MergedSearchViewPeptidesForm form,
