...
/**
 * 
 * Manage Cached results for ViewerMonolinkService PsmCount
 * 
 ...
 * Singleton
 */
public class ViewerMonolinkService_Results_PsmCount_CachedResultManager implements CachedDataInFileMgmtRegistrationIF {

	private static final Logger log = LoggerFactory.getLogger(  ViewerMonolinkService_Results_PsmCount_CachedResultManager.class );
	
	private static final String PREFIX_FOR_CACHING = "ViewerMonolinkService_PsmCount_";

	static final int VERSION_FOR_CACHING_FROM_MAIN_CLASS = ViewerMonolinkService.VERSION_FOR_CACHING;
	
	
	private static final ViewerMonolinkService_Results_PsmCount_CachedResultManager instance = new ViewerMonolinkService_Results_PsmCount_CachedResultManager();

	// private constructor
	private ViewerMonolinkService_Results_PsmCount_CachedResultManager() {}

	/**
	 * @return Singleton instance
	 */
	public static ViewerMonolinkService_Results_PsmCount_CachedResultManager getSingletonInstance() {
		return instance;
	}
	
	public static class ViewerMonolinkService_Results_PsmCount_CachedResultManager_Result {
	 ...
	 * @throws Exception
	 */
	public ViewerMonolinkService_Results_PsmCount_CachedResultManager_Result retrieveDataFromCache( List<Integer> projectSearchIds, String requestQueryString ) throws Exception {
		
		if ( ! CachedDataInFileMgmt.getSingletonInstance().isCachedDataFilesDirConfigured() ) {
			return null;  //  EARLY EXIT
		}
				
		ViewerMonolinkService_Results_PsmCount_CachedResultManager_Result result = new ViewerMonolinkService_Results_PsmCount_CachedResultManager_Result();
