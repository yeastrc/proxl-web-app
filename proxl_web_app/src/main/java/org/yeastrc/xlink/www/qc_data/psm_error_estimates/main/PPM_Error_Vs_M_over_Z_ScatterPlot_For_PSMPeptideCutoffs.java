...
import org.yeastrc.xlink.www.qc_data.psm_error_estimates.main.PPM_Error_Vs_M_over_Z_ScatterPlot_For_PSMPeptideCutoffs_CachedResultManager.PPM_Error_Vs_M_over_Z_ScatterPlot_For_PSMPeptideCutoffs_CachedResultManager_Result;
...
public class PPM_Error_Vs_M_over_Z_ScatterPlot_For_PSMPeptideCutoffs {
	...
	private static final Logger log = LoggerFactory.getLogger( PPM_Error_Vs_M_over_Z_ScatterPlot_For_PSMPeptideCutoffs.class);
	...
	/**
	 * Response from call to getPPM_Error_Vs_M_over_Z_ScatterPlot_For_PSMPeptideCutoffs(...)
	 *
	 */
	public static class PPM_Error_Vs_M_over_Z_ScatterPlot_For_PSMPeptideCutoffs_Method_Response {

		private byte[] resultsAsBytes; //  ppm_Error_Vs_M_over_Z_ScatterPlot_For_PSMPeptideCutoffs_Result as JSON
		
		private PPM_Error_Vs_M_over_Z_ScatterPlot_For_PSMPeptideCutoffs_Result ppm_Error_Vs_M_over_Z_ScatterPlot_For_PSMPeptideCutoffs_Result;
		
		/**
		 * Map<[link type], ...>
		 */
		private Map<String, List<PPMErrorM_over_ZPair>> ppmErrorListForLinkType_ByLinkType;
		public PPM_Error_Vs_M_over_Z_ScatterPlot_For_PSMPeptideCutoffs_Result getPpm_Error_Vs_M_over_Z_ScatterPlot_For_PSMPeptideCutoffs_Result() {
			return ppm_Error_Vs_M_over_Z_ScatterPlot_For_PSMPeptideCutoffs_Result;
		}
		public void setPpm_Error_Vs_M_over_Z_ScatterPlot_For_PSMPeptideCutoffs_Result(
			...
			this.ppm_Error_Vs_M_over_Z_ScatterPlot_For_PSMPeptideCutoffs_Result = ppm_Error_Vs_M_over_Z_ScatterPlot_For_PSMPeptideCutoffs_Result;
		}
		/**
		 * Map<[link type], ...>
		 * @return
		 */
		public Map<String, List<PPMErrorM_over_ZPair>> getPpmErrorListForLinkType_ByLinkType() {
	 ...
	 * @throws Exception
	 */
	public PPM_Error_Vs_M_over_Z_ScatterPlot_For_PSMPeptideCutoffs_Method_Response getPPM_Error_Vs_M_over_Z_ScatterPlot_For_PSMPeptideCutoffs( 
		...
		if ( forDownload != ForDownload.YES ) {
			...
			if ( searchOnlyHasDefaultCutoffs ) {
				...
				if ( resultsAsBytes != null ) {
					...
					PPM_Error_Vs_M_over_Z_ScatterPlot_For_PSMPeptideCutoffs_Method_Response methodResponse = new PPM_Error_Vs_M_over_Z_ScatterPlot_For_PSMPeptideCutoffs_Method_Response();
		...
		Map<String, List<PPMErrorM_over_ZPair>> ppmErrorListForLinkType_ByLinkType = 
				create_ppmErrorListForLinkType_ByLinkTypeMap( mergedPeptideQueryJSONRoot_SearcherCutoffValuesRootLevel_Holder, search );
		...
		methodResponse.ppm_Error_Vs_M_over_Z_ScatterPlot_For_PSMPeptideCutoffs_Result = ppm_Error_Vs_M_over_Z_ScatterPlot_For_PSMPeptideCutoffs_Result;
	 ...
	 * @throws IOException
	 */
	private byte[] getResultsByteArray( PPM_Error_Vs_M_over_Z_ScatterPlot_For_PSMPeptideCutoffs_Result resultsObject, int searchId ) throws IOException {
	...
	private byte[] retrieveDataFromCacheAndMatchCutoffs( SearchDTO search,
		...
		PPM_Error_Vs_M_over_Z_ScatterPlot_For_PSMPeptideCutoffs_CachedResultManager_Result cachedDataResult =
				PPM_Error_Vs_M_over_Z_ScatterPlot_For_PSMPeptideCutoffs_CachedResultManager.getSingletonInstance()
...
//		List<PPM_Error_ComputeEntry> ppm_Error_ComputeEntryList = new ArrayList<>( 10 );
	 ...
	 *
	 */
	public static class PPMErrorM_over_ZPair {
		private BigDecimal m_over_z;
		private double ppmError;
		public BigDecimal getM_over_z() {
			return m_over_z;
		}
		public void setM_over_z(BigDecimal m_over_z) {
