...
/**
 * 
 * Download data for QC Chart Digestion Fraction Missed Cleavages Per Peptide
 */
public class DownloadQC_Digestion_MissedCleavagePerPeptideChartDataAction {
	
	private static final Logger log = LoggerFactory.getLogger( DownloadQC_Digestion_MissedCleavagePerPeptideChartDataAction.class);
...
//			Collections.sort( searchIds );
			...
			try {
				...
				List<QC_MissingCleavageReportedPeptidesCountResultsPerLinkType_Merged> perPeptideCountPerLinkTypeList =
						qc_MissingCleavageReportedPeptidesCount_Merged_Results.getPerPeptideCountPerLinkTypeList();
				
				List<String> linkTypesList = new ArrayList<>( perPeptideCountPerLinkTypeList.size() );
				for ( QC_MissingCleavageReportedPeptidesCountResultsPerLinkType_Merged resultPerLinkType : perPeptideCountPerLinkTypeList ) {
				...
				// generate file name
				String filename = "proxl-qc-digestion-missed-cleavages-per-peptide-search-"
