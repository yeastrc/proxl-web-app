 ...
 */
public class DownloadQC_Psm_PPM_Error_ChartDataAction {
	
	private static final Logger log = LoggerFactory.getLogger( DownloadQC_Psm_PPM_Error_ChartDataAction.class);
