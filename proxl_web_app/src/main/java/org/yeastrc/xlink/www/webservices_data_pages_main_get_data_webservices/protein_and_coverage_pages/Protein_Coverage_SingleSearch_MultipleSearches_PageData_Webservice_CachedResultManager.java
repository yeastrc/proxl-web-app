...
/**
 * 
 * Manage Cached results for Protein_Coverage_SingleSearch_MultipleSearches_PageData_Webservice
 * 
 ...
 * Singleton
 */
public class Protein_Coverage_SingleSearch_MultipleSearches_PageData_Webservice_CachedResultManager implements CachedDataInFileMgmtRegistrationIF {

	private static final Logger log = LoggerFactory.getLogger(  Protein_Coverage_SingleSearch_MultipleSearches_PageData_Webservice_CachedResultManager.class );
	
	private static final String PREFIX_FOR_CACHING = "Proteins_Coverage_SingleSearch_MultipleSearches_PageMainDisplayService_";

	static final int VERSION_FOR_CACHING_FROM_MAIN_CLASS = Protein_Coverage_SingleSearch_MultipleSearches_PageData_Webservice.VERSION_FOR_CACHING;
	
	
	private static final Protein_Coverage_SingleSearch_MultipleSearches_PageData_Webservice_CachedResultManager instance = new Protein_Coverage_SingleSearch_MultipleSearches_PageData_Webservice_CachedResultManager();

	// private constructor
	private Protein_Coverage_SingleSearch_MultipleSearches_PageData_Webservice_CachedResultManager() {}

	/**
	 * @return Singleton instance
	 */
	public static Protein_Coverage_SingleSearch_MultipleSearches_PageData_Webservice_CachedResultManager getSingletonInstance() {
		return instance;
	}
	
	public static class Protein_Coverage_SingleSearch_MultipleSearches_PageData_Webservice_CachedResultManager_Result {
	 ...
	 * @throws Exception
	 */
	public Protein_Coverage_SingleSearch_MultipleSearches_PageData_Webservice_CachedResultManager_Result retrieveDataFromCache( 
		...
		Protein_Coverage_SingleSearch_MultipleSearches_PageData_Webservice_CachedResultManager_Result result = new Protein_Coverage_SingleSearch_MultipleSearches_PageData_Webservice_CachedResultManager_Result();
