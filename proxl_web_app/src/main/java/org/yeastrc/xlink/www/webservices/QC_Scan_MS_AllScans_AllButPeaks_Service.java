...
import org.yeastrc.xlink.www.qc_data.scan_level_data.main.Scan_MS_AllScans_AllButPeaks;
...
@Path("/qc/dataPage")
public class QC_Scan_MS_AllScans_AllButPeaks_Service {
	
	private static final Logger log = LoggerFactory.getLogger( QC_Scan_MS_AllScans_AllButPeaks_Service.class);

	/**
	 * Input to function getScan_MS_AllScans_AllButPeaks(..)
	 */
	...
	@Path("/getScanData_AllScans_AllButPeaks") 
	public byte[] getScanData_MS_AllScans_AllButPeaks( 
...
//			UserSession userSession = accessAndSetupWebSessionResult.getUserSession();
			...
			byte[] resultsAsBytes = 
					Scan_MS_AllScans_AllButPeaks.getInstance()
					.getScan_MS_AllScans_AllButPeaks( scanFileId, requestJSONBytes );
