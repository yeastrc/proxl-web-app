...
/**
 * 
 * Manage Cached results for PPM_Error_Histogram_For_PSMPeptideCutoffs
 * 
 ...
 * Singleton
 */
public class PPM_Error_Histogram_For_PSMPeptideCutoffs_CachedResultManager implements CachedDataInFileMgmtRegistrationIF {

	private static final Logger log = LoggerFactory.getLogger(  PPM_Error_Histogram_For_PSMPeptideCutoffs_CachedResultManager.class );
	
	private static final String PREFIX_FOR_CACHING = "PPM_Error_Histogram_";
	
	static final int VERSION_FOR_CACHING_FROM_MAIN_CLASS = PPM_Error_Histogram_For_PSMPeptideCutoffs.VERSION_FOR_CACHING;
	
	private static final PPM_Error_Histogram_For_PSMPeptideCutoffs_CachedResultManager instance = new PPM_Error_Histogram_For_PSMPeptideCutoffs_CachedResultManager();

	// private constructor
	private PPM_Error_Histogram_For_PSMPeptideCutoffs_CachedResultManager() {}

	/**
	 * @return Singleton instance
	 */
	public static PPM_Error_Histogram_For_PSMPeptideCutoffs_CachedResultManager getSingletonInstance() {
		return instance;
	}
	
	public static class PPM_Error_Histogram_For_PSMPeptideCutoffs_CachedResultManager_Result {
	 ...
	 * @throws Exception
	 */
	public PPM_Error_Histogram_For_PSMPeptideCutoffs_CachedResultManager_Result retrieveDataFromCache( int projectSearchId, String requestQueryString ) throws Exception {
		...
		PPM_Error_Histogram_For_PSMPeptideCutoffs_CachedResultManager_Result result = new PPM_Error_Histogram_For_PSMPeptideCutoffs_CachedResultManager_Result();
