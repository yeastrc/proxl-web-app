...
/**
 * Spring MVC controller for paths /mergedCrosslinkProtein.do and /mergedLooplinkProtein.do
 *
 * <p>The {@code parameter} attribute was already unused in the
 * action (commented out) - the two paths run identical logic and differ only in the Success JSP.
 */
@Controller
public class ViewMergedSearchProteinsController {

	private static final Logger log = LoggerFactory.getLogger( ViewMergedSearchProteinsController.class );

	@RequestMapping( A__SpringMVC_Controller_Paths.ViewMergedSearchProteinsController_mergedCrosslinkProtein )
	public String mergedCrosslinkProtein(
			@ModelAttribute( "mergedSearchViewProteinForm" ) MergedSearchViewProteinsForm form,
			HttpServletRequest request,
			HttpServletResponse response ) throws Exception {
		return handle( "viewMergedCrosslinkProtein", form, request, response );
	}

	@RequestMapping( A__SpringMVC_Controller_Paths.ViewMergedSearchProteinsController_mergedLooplinkProtein )
	public String mergedLooplinkProtein(
			@ModelAttribute( "mergedSearchViewProteinForm" ) MergedSearchViewProteinsForm form,
			HttpServletRequest request,
			HttpServletResponse response ) throws Exception {
		return handle( "viewMergedLooplinkProtein", form, request, response );
	}
