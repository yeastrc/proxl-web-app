...
@Path("/qc/dataPage")
public class QC_MissingCleavage_Merged_Service {

	private static final Logger log = LoggerFactory.getLogger( QC_MissingCleavage_Merged_Service.class);
...
//			UserSession userSession = accessAndSetupWebSessionResult.getUserSession();
			...
			serviceResult.result = qc_MissingCleavageReportedPeptidesCount_Merged_Results;
	 ...
	 *
	 */
	public static class WebserviceResult_getQC_MissingCleavageReportedPeptidesCount_Merged {

		private QC_MissingCleavageReportedPeptidesCount_Merged_Results result;

		public QC_MissingCleavageReportedPeptidesCount_Merged_Results getResult() {
			return result;
		}

		public void setResult(QC_MissingCleavageReportedPeptidesCount_Merged_Results result) {
			this.result = result;
		}
