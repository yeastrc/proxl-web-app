...
/**
 * Spring MVC controller for path /allProtein.do
 */
@Controller
public class ViewSearchProteinsAllController {

	private static final Logger log = LoggerFactory.getLogger( ViewSearchProteinsAllController.class );

	@RequestMapping( A__SpringMVC_Controller_Paths.ViewSearchProteinsAllController_allProtein )
	public String allProtein(
