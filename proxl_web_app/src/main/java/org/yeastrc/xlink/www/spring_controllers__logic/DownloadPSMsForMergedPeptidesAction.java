 ...
 *
 */
public class DownloadPSMsForMergedPeptidesAction {

	private static final Logger log = LoggerFactory.getLogger( DownloadPSMsForMergedPeptidesAction.class);
	
	public String execute( MergedSearchViewPeptidesForm form, HttpServletRequest request, HttpServletResponse response ) throws Exception {
		try {
			// our form
