...
/**
 * Spring MVC controller for path /mergedAllProtein.do
 */
@Controller
public class ViewMergedSearchProteinsAllController {

	private static final Logger log = LoggerFactory.getLogger( ViewMergedSearchProteinsAllController.class );

	@RequestMapping( A__SpringMVC_Controller_Paths.ViewMergedSearchProteinsAllController_mergedAllProtein )
	public String mergedAllProtein(
