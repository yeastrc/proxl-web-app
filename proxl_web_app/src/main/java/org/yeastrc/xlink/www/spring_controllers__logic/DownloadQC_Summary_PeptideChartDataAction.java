 ...
 */
public class DownloadQC_Summary_PeptideChartDataAction {
	
	private static final Logger log = LoggerFactory.getLogger( DownloadQC_Summary_PeptideChartDataAction.class);
