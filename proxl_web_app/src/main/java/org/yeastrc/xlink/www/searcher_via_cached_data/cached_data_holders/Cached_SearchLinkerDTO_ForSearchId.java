 ...
 * Cache Value: SearchLinkerDTO_ForSearchId_Response searchLinkerDTO_ForSearchId_Response;
 */
public class Cached_SearchLinkerDTO_ForSearchId implements CachedDataCommonIF {

	private static final Logger log = LoggerFactory.getLogger(  Cached_SearchLinkerDTO_ForSearchId.class );
	 ...
	 */
	private static Cached_SearchLinkerDTO_ForSearchId _instance = null; //  Delay creating until first getInstance() call
	 ...
	 * @throws Exception 
	 */
	public static synchronized Cached_SearchLinkerDTO_ForSearchId getInstance() throws Exception {

		if ( _instance == null ) {
			_instance = new Cached_SearchLinkerDTO_ForSearchId();
		}
		return _instance; 
	}
	 ...
	 * constructor
	 */
	private Cached_SearchLinkerDTO_ForSearchId() {
	 ...
	 * @throws Exception
	 */
	public SearchLinkerDTO_ForSearchId_Response getSearchLinkers_ForSearchId_Response( Integer searchId ) throws Exception {
		...
		LoadingCache<Integer, SearchLinkerDTO_ForSearchId_Response> cache = cacheHolderInternal.getCache();
		
		if ( cache != null ) {
			SearchLinkerDTO_ForSearchId_Response searchLinkerDTO_ForSearchId_Response = cache.get( searchId );
			return searchLinkerDTO_ForSearchId_Response; // EARLY return
		}
		
		SearchLinkerDTO_ForSearchId_Response searchLinkerDTO_ForSearchId_Response = cacheHolderInternal.loadFromDB( searchId );
		return searchLinkerDTO_ForSearchId_Response;
	}
	...
	private static class CacheHolderInternal {
		...
		private Cached_SearchLinkerDTO_ForSearchId parentObject;
		
		private CacheHolderInternal( Cached_SearchLinkerDTO_ForSearchId parentObject ) {
		 ...
		 */
		private LoadingCache<Integer, SearchLinkerDTO_ForSearchId_Response> dbRecordsDataCache = null;
		...
		private synchronized LoadingCache<Integer, SearchLinkerDTO_ForSearchId_Response> getCache(  ) throws Exception {
			if ( ! cacheDataInitialized ) { 
				...
				cacheMaxSize = Cached_SearchLinkerDTO_ForSearchId.CACHE_MAX_SIZE_FULL_SIZE;
				if ( cachedDataSizeOptions == CachedDataSizeOptions.HALF ) {
					...
					cacheMaxSize = Cached_SearchLinkerDTO_ForSearchId.CACHE_MAX_SIZE_SMALL;
				...
				dbRecordsDataCache = CacheBuilder.newBuilder()
						...
						.build(
								new CacheLoader<Integer, SearchLinkerDTO_ForSearchId_Response>() {
									@Override
									public SearchLinkerDTO_ForSearchId_Response load(Integer searchId) throws Exception {
		 ...
		 * @throws Exception
		 */
		private SearchLinkerDTO_ForSearchId_Response loadFromDB( Integer searchId ) throws Exception {
			...
			SearchLinkerDTO_ForSearchId_Response searchLinkerDTO_ForSearchId_Response = new SearchLinkerDTO_ForSearchId_Response();
			searchLinkerDTO_ForSearchId_Response.setSearchLinkerDTOList( searchLinkerDTOList );
			return searchLinkerDTO_ForSearchId_Response;
		}
 	}
