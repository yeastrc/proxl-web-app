 ...
 */
public class DownloadQC_Psm_PPM_Error_VS_RT_ChartDataAction {
	
	private static final Logger log = LoggerFactory.getLogger( DownloadQC_Psm_PPM_Error_VS_RT_ChartDataAction.class);
