...
/**
 * Protein Crosslink Single Search Page Main List of Proteins and statistics above the List
 *
 */
@Path("/proteinPage-Crosslink-SingleSearch-MainDisplay") 
public class Protein_Crosslink_SingleSearch_PageData_Webservice {
...
//	private static final Logger log = LoggerFactory.getLogger( Protein_crosslink_SingleSearch_PageData_Webservice.class);
	...
	throws Exception {
		...
		return Protein_crosslink_looplink_Common_SingleSearch_PageData_Webservice.getNewInstance()
				.processRequest( requestJSONBytes, CrosslinkLooplink.CROSSLINK, request );
	}
