...
import org.yeastrc.xlink.www.spring_controllers__logic.PeptidesMergedCommonPageDownload.PeptidesMergedCommonPageDownloadResult;
 ...
 *
 */
public class DownloadMergedPeptidesForSkylinePRMAction {
	
	private static final Logger log = LoggerFactory.getLogger( DownloadMergedPeptidesForSkylinePRMAction.class);
	
	public String execute( MergedSearchViewPeptidesForm form, HttpServletRequest request, HttpServletResponse response )
					  throws Exception {
		try {
			// our form
