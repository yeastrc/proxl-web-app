...
public class MergedSearchPeptideCrosslink implements IMergedSearchLink {
	...
	private static final Logger log = LoggerFactory.getLogger( MergedSearchPeptideCrosslink.class);
	...
	private void populatePeptides() throws Exception {
		try {
			...
			modsStringPeptide1 = FormatDynamicModsToString.formatDynamicModsToString( unifiedRpDynamicModListPeptide1 ) + "MMMMMMM";
