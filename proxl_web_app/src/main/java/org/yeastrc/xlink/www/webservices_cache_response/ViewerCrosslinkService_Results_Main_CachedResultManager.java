...
/**
 * 
 * Manage Cached results for ViewerCrosslinkService
 * 
...
public class ViewerCrosslinkService_Results_Main_CachedResultManager implements CachedDataInFileMgmtRegistrationIF {
	...
	private static final ViewerCrosslinkService_Results_Main_CachedResultManager instance = new ViewerCrosslinkService_Results_Main_CachedResultManager();

	// private constructor
	private ViewerCrosslinkService_Results_Main_CachedResultManager() {}

	/**
	 * @return Singleton instance
	 */
	public static ViewerCrosslinkService_Results_Main_CachedResultManager getSingletonInstance() {
		return instance;
	}
	
	public static class ViewerCrosslinkService_Results_Main_CachedResultManager_Result {
	 ...
	 * @throws Exception
	 */
	public ViewerCrosslinkService_Results_Main_CachedResultManager_Result retrieveDataFromCache( 
		...
		ViewerCrosslinkService_Results_Main_CachedResultManager_Result result = new ViewerCrosslinkService_Results_Main_CachedResultManager_Result();
