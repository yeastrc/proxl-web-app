...
public class ProxlXMLFileUploadMaxFileSizeConstants {
	...
	public static final long MAX_PROXL_XML_FILE_UPLOAD_SIZE = ( 350 * ( (long) ( 1000 * 1000 ) ) ); // 350MB max
...
//	public static final int MAX_SCAN_FILE_UPLOAD_SIZE = ( 2 * 10 * 1000  ); // temp smaller max of 20KB
	...
	public static final String MAX_PROXL_XML_FILE_UPLOAD_SIZE_FORMATTED = "350MB";
