 ...
 *
 */
public class SpringMvc_Config_Parameter_Values_Constants {

	
	//  Struts config action mapping:     parameter="crosslink"
	
	public static final String PARAMETER__CROSSLINK = "crosslink";

	//  Struts config action mapping:     parameter="looplink"

	public static final String PARAMETER__LOOPLINK = "looplink";
	...
	public static final String PARAMETER__MERGED_PROTEIN_COVERAGE_PAGE = "mergedPage";

	//  Struts config action mapping:     parameter="notMergedPage"

	public static final String PARAMETER__NOT__MERGED_PROTEIN_COVERAGE_PAGE = "notMergedPage";
