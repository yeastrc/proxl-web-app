...
/**
 * 
 * Manage Cached results for ViewerLooplinkService PsmCount
 * 
 ...
 * Singleton
 */
public class ViewerLooplinkService_Results_PsmCount_CachedResultManager implements CachedDataInFileMgmtRegistrationIF {

	private static final Logger log = LoggerFactory.getLogger(  ViewerLooplinkService_Results_PsmCount_CachedResultManager.class );
	
	private static final String PREFIX_FOR_CACHING = "ViewerLooplinkService_PsmCount_";

	static final int VERSION_FOR_CACHING_FROM_MAIN_CLASS = ViewerLooplinkService.VERSION_FOR_CACHING;
	
	
	private static final ViewerLooplinkService_Results_PsmCount_CachedResultManager instance = new ViewerLooplinkService_Results_PsmCount_CachedResultManager();

	// private constructor
	private ViewerLooplinkService_Results_PsmCount_CachedResultManager() {}

	/**
	 * @return Singleton instance
	 */
	public static ViewerLooplinkService_Results_PsmCount_CachedResultManager getSingletonInstance() {
		return instance;
	}
	
	public static class ViewerLooplinkService_Results_PsmCount_CachedResultManager_Result {
	 ...
	 * @throws Exception
	 */
	public ViewerLooplinkService_Results_PsmCount_CachedResultManager_Result retrieveDataFromCache( List<Integer> projectSearchIds, String requestQueryString ) throws Exception {
		
		if ( ! CachedDataInFileMgmt.getSingletonInstance().isCachedDataFilesDirConfigured() ) {
			return null;  //  EARLY EXIT
		}
				
		ViewerLooplinkService_Results_PsmCount_CachedResultManager_Result result = new ViewerLooplinkService_Results_PsmCount_CachedResultManager_Result();
