...
/**
 * 
 * Manage Cached results for Protein_crosslink_looplink_Common_MultipleSearches_PageData_Webservice
 * 
 ...
 * Singleton
 */
public class Protein_crosslink_looplink_Common_MultipleSearches_PageData_Webservice_CachedResultManager implements CachedDataInFileMgmtRegistrationIF {

	private static final Logger log = LoggerFactory.getLogger(  Protein_crosslink_looplink_Common_MultipleSearches_PageData_Webservice_CachedResultManager.class );
	
	private static final String PREFIX_FOR_CACHING = "ProteinPage_MultipleSearches_MainDisplayService_";
	...
	static final int VERSION_FOR_CACHING_FROM_MAIN_CLASS = Protein_crosslink_looplink_Common_MultipleSearches_PageData_Webservice.VERSION_FOR_CACHING;
	
	
	private static final Protein_crosslink_looplink_Common_MultipleSearches_PageData_Webservice_CachedResultManager instance = new Protein_crosslink_looplink_Common_MultipleSearches_PageData_Webservice_CachedResultManager();

	// private constructor
	private Protein_crosslink_looplink_Common_MultipleSearches_PageData_Webservice_CachedResultManager() {}

	/**
	 * @return Singleton instance
	 */
	public static Protein_crosslink_looplink_Common_MultipleSearches_PageData_Webservice_CachedResultManager getSingletonInstance() {
		return instance;
	}
	
	public static class Protein_crosslink_looplink_Common_MultipleSearches_PageData_Webservice_CachedResultManager_Result {
	...
	/**
	 * @param forCrosslinksOrLooplinkOrBoth - Re-use since used to call processRequest in Protein_crosslink_looplink_Common_MultipleSearches_PageData_Webservice
	 * @param projectSearchIds
	 * @param requestQueryString
	 * @return
	 * @throws Exception
	 */
	public Protein_crosslink_looplink_Common_MultipleSearches_PageData_Webservice_CachedResultManager_Result retrieveDataFromCache( 
			ForCrosslinksOrLooplinkOrBoth forCrosslinksOrLooplinkOrBoth, //  Re-use since used to call processRequest in Protein_crosslink_looplink_Common_MultipleSearches_PageData_Webservice
		...
		Protein_crosslink_looplink_Common_MultipleSearches_PageData_Webservice_CachedResultManager_Result result = new Protein_crosslink_looplink_Common_MultipleSearches_PageData_Webservice_CachedResultManager_Result();
		...
		if ( forCrosslinksOrLooplinkOrBoth == ForCrosslinksOrLooplinkOrBoth.CROSSLINKS ) {
			...
			String msg = "Invalid value for forCrosslinksOrLooplinkOrBoth: " + forCrosslinksOrLooplinkOrBoth;
			log.error( msg );
	...
	public void saveDataToCache( 
		...
		if ( forCrosslinksOrLooplinkOrBoth == ForCrosslinksOrLooplinkOrBoth.CROSSLINKS ) {
			...
			String msg = "Invalid value for crosslinkLooplink: " + forCrosslinksOrLooplinkOrBoth;
			log.error( msg );
			throw new InvalidParameterException(msg);
		}
