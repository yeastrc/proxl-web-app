...
public class SearchPeptideWebserviceCommonCode {
	...
	/**
	 * Result Class from getPeptideAndPSMDataForLinksAndSortLinks(...) method
	 *
	 */
	...
	public SearchPeptideWebserviceCommonCodeGetDataResult getPeptideAndPSMDataForLinksAndSortLinks( 
		...
		if ( peptideFilterableAnnotationTypesForSearchId == null ) {
			peptideFilterableAnnotationTypesForSearchId = new HashMap<>(); // Some searches don't have Peptide Annotations bappDataException( msg );
		}
		...
		if ( peptideDescriptiveAnnotationTypesForSearchId == null ) {
			peptideDescriptiveAnnotationTypesForSearchId = new HashMap<>(); // Some searches don't have Peptide Annotations
		}
		/////////////
