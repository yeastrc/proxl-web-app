...
<%--  Replaced with the JS bundle listed next
		...
		<script type="text/javascript" src="js/viewLooplinkProteinsLoadedFromWebServiceTemplate.js?x=${cacheBustValue}"></script>
		...
		<script type="text/javascript" src="js/viewMergedLooplinkProteinPage.js?x=${cacheBustValue}"></script>
