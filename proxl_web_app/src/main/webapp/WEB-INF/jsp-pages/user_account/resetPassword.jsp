...
<head>
 ...
 <link REL="stylesheet" TYPE="text/css" HREF="static/css_generated/global.css?x=${cacheBustValue}">
	...
	<script type="text/javascript" src="static/js_generated_bundles/user_pages/userResetPasswordPage-bundle.js?x=${ cacheBustValue }"></script>

<%--  Moved to Front End Build Bundles		
	
		<script type="text/javascript" src="js/user_account/userResetPasswordPage.js?x=${cacheBustValue}"></script>
--%>
