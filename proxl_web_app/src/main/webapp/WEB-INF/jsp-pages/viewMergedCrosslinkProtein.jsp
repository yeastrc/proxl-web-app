...
<%--  Replaced with the JS bundle listed next
		...
		<script type="text/javascript" src="js/viewCrosslinkProteinsLoadedFromWebServiceTemplate.js?x=${cacheBustValue}"></script>
		...
		<script type="text/javascript" src="js/viewMergedCrosslinkProteinPage.js?x=${cacheBustValue}"></script>
	...
	<c:forEach var="projectSearchId" items="${ projectSearchIds }">
		...
		<div>
			...
			<div style="display:inline;">
				[<a class="tool_tip_attached_jq" data-tooltip="View looplinks (instead of crosslinks)" href="mergedLooplinkProtein.do?<bean:write name="queryString" />">View Looplinks (<bean:write name="numLooplinks" />)</a>]
