			...
			<div id="main_items_below_filter_criteria_table_above_main_display_table" style="display: none;"> 
				...
				<div>
					...
					<div style="display:inline;">
						[<a class="tool_tip_attached_jq" data-tooltip="View looplinks (instead of crosslinks)" href="mergedLooplinkProtein.do?<c:out value="${ queryString }" />">View Looplinks (<span id="numLooplinks"></span>)</a>]
