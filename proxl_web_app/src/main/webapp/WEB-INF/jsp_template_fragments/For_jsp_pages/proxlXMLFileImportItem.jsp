...
<tr class=" proxl_xml_import_item_row_jq " 
  ...
  <td class=" clickable proxl_xml_import_item_expand_collapse_row_clickable_jq " style="vertical-align: top; padding-top: 2px;">
	  <img src="images/icon-expand-small.png" class=" proxl_xml_import_item_expand_row_icon_jq tool_tip_attached_jq "
	  		data-tooltip="Show Details" >
	  <img src="images/icon-collapse-small.png" class=" proxl_xml_import_item_collapse_row_icon_jq tool_tip_attached_jq " 
