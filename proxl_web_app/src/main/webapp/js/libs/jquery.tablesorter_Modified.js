...
//  jquery.tablesorter_Modified.js

//  Pretty print version of jquery.tablesorter.min.js  from Google Chrome

//  Altered to select <th> elements under the <thead> directly under the table the tablesorter is attached to 

(function($) {
    $.extend({
        tablesorter: new function() {
        	
        	var SELECTOR_HEADERS_DEFAULT = 'thead th'; // change code where this is used if changed from 'thead th'
            ...
            this.defaults = {
                ...
                decimal: '/\.|\,/g',
                onRenderHeader: null,
                selectorHeaders: SELECTOR_HEADERS_DEFAULT,
                debug: false
            };
...
//              $tableHeaders = $(table.config.selectorHeaders, table).each(function(index) {
                ...
                if ( table.config.selectorHeaders !== SELECTOR_HEADERS_DEFAULT ) {
                	$tableHeaders = $(table.config.selectorHeaders, table);
                } else {
                	//  Special code for default 
                	var $table = $( table );
                	var $theadOfTable = $table.children("thead");
                	$tableHeaders = $theadOfTable.find("th");
                }
