...
<%@ include file="/WEB-INF/jsp-includes/jstlTaglibImport.jsp" %>
 ...
 <c:set var="headerAdditions">
		...
		<%--  New tablesorter version 2017 06 02  - Sorts but doesn't update the headers with icons or highlight sort columns --%>
		<%--
		<script type="text/javascript" src="${ contextPath }/js/libs/jquery.tablesorter.combined.js"></script>
		--%>
		
		<%--  Old tablesorter version  --%>
		<%--   --%>
		...
		<div class="overall-enclosing-block">
			...
			if ( window.viewSearchPeptidePageCode ) {
  			...
  			<div > <%--  style="display: none;"   --%>
				...
				<table style="display: none;" id="crosslink-table" class="tablesorter  top_data_table_jq ">
