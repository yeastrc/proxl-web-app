...
//	$delete_search_confirm_button.data("searchId", searchId);
	...
	var $scan_retention_time_qc_plot_current_project_search_id = $("#scan_retention_time_qc_plot_current_project_search_id");
	var prevProjectSearchId = $scan_retention_time_qc_plot_current_project_search_id.val( );
	...
	$scan_retention_time_qc_plot_current_project_search_id.val( projectSearchId );
	...
	var afterGetScanFileIdsForProjectSearchId = function() {
		objectThis.getPSMFilterableAnnTypesForProjectSearchId( { projectSearchId : projectSearchId } );
	};
	this.getScanFileIdsForProjectSearchId( { 
		projectSearchId: projectSearchId, 
		callback: afterGetScanFileIdsForProjectSearchId } );
};
...
//////////
///  
QCChartRetentionTime.prototype.getPSMFilterableAnnTypesForProjectSearchId = function( params ) {
	var objectThis = this;
...
///
QCChartRetentionTime.prototype.getPSMFilterableAnnTypesForProjectSearchIdResponse = function(requestData, responseData, originalParams) {
	...
	this.getPSMFilterableMaxMinValuesAnnTypes( { projectSearchId : originalParams.projectSearchId } );
};
...
QCChartRetentionTime.prototype.getPSMFilterableMaxMinValuesAnnTypes = function( params ) {
	...
	var _URL = contextPathJSVar + "/services/annotationTypes/getMinMaxValuesForPsmFilterableAnnTypeIdsProjectSearchId";
	var requestData = {
			projectSearchId : projectSearchId,
...
QCChartRetentionTime.prototype.getPSMFilterableMaxMinValuesAnnTypesResponse = function(requestData, responseData, originalParams) {
	...
	this.populateAnnTypesSelect( { projectSearchId : originalParams.projectSearchId } );
};
...
//////////
///  
QCChartRetentionTime.prototype.getScanFileIdsForProjectSearchId = function( params ) {
	var objectThis = this;
	var projectSearchId = params.projectSearchId;
	if ( ! qcChartsInitialized ) {
		throw "qcChartsInitialized is false"; 
...
//	var request =
	$.ajax({
		...
		success : function(data) {
			try {
				objectThis.getScanFileIdsForProjectSearchIdResponse(requestData, data, params);
			} catch( e ) {
				reportWebErrorToServer.reportErrorObjectToServer( { errorException : e } );
				throw e;
			}
...
///
QCChartRetentionTime.prototype.getScanFileIdsForProjectSearchIdResponse = function(requestData, responseData, originalParams) {
//	var objectThis = this;
...
QCChartRetentionTime.prototype.createRetentionTimeCountChartFromPageParams = function( ) {
	...
	var $scan_retention_time_qc_plot_current_project_search_id = $("#scan_retention_time_qc_plot_current_project_search_id");
	var projectSearchId = $scan_retention_time_qc_plot_current_project_search_id.val( );
	var $scan_retention_time_qc_plot_scan_file_id = $("#scan_retention_time_qc_plot_scan_file_id");
