...
export class LinkablePositionUtils {
    ...
    static getRenderedDistanceArray( renderedLinks ) {
        ...
        if( renderedLinks.looplinks ) {
            for (let i = 0; i < renderedLinks['looplinks'].length; i++) {
                ...
                if( !this.isLooplinkInCountedUDRs( { UDRsCounted, link: renderedLinks['looplinks'][i]})) {
    ...
    static isLooplinkInCountedUDRs({UDRsCounted, link}) {
        ...
        if( protein1 in UDRsCounted &&
            ...
            position1 in UDRsCounted[ protein1 ][ protein1 ] &&
            (position2 in UDRsCounted[ protein1 ][ protein1 ][ position1 ] || position1 in UDRsCounted[ protein1 ][ protein1 ][ position2 ]) ) {
    ...
    static getDistanceArrayFromLinkablePositions( { data, visibleProteinsMap, onlyShortest, alignments, structure } ) {
