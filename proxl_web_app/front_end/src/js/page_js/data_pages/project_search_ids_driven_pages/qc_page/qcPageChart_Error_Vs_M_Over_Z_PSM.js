/**
 * qcPageChart_Error_Vs_M_Over_Z_PSM.js
 * 
 * Javascript for the viewQC.jsp page - Chart Error Vs M/Z - in PSM Error section
 * 
 * page variable qcPageChart_Error_Vs_M_Over_Z_PSM
 * 
 ...
 * Constructor 
 */
var QCPageChart_Error_Vs_M_Over_Z_PSM = function() {
	
	//  Download data URL
	var _downloadStrutsAction = "downloadQC_Psm_PPM_Error_VS_MZ_ChartData.do";
...
//					linkType : selectedLinkType, 
	...
	this.load_PPM_Error_Vs_M_over_Z_For_PSMs_ScatterPlotForLinkType = function( params ) {
		...
		_activeAjax[ selectedLinkType ] = 
			$.ajax({
//				cache : false,
				url : "services/qc/dataPage/ppmErrorVsM_over_Z", // ppmErrorVsM_over_Z
...
//			var clickedThis = params.clickedThis;
		...
		var elementId = "psm_error_block_help_tooltip_error_vs_m_over_z_" + linkType
		var $psm_error_block_help_tooltip_error_vs_m_over_z_LinkType = $("#" + elementId );
		if ( $psm_error_block_help_tooltip_error_vs_m_over_z_LinkType.length === 0 ) {
			throw Error( "No element found with id '" + elementId + "' " );
		}
		var helpTooltipHTML = $psm_error_block_help_tooltip_error_vs_m_over_z_LinkType.html();
...
var qcPageChart_Error_Vs_M_Over_Z_PSM = new QCPageChart_Error_Vs_M_Over_Z_PSM();

export { qcPageChart_Error_Vs_M_Over_Z_PSM }
