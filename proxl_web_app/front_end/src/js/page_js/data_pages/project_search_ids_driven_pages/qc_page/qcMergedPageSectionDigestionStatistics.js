/**
 * qcMergedPageSectionDigestionStatistics.js
 * 
 * Javascript for the viewQCMerged.jsp page - Section Digestion Statistics
 * 
 * page variable qcMergedPageSectionDigestionStatistics
 * 
 * Merged QC Page  
 * 
 */
...
import { qcMergedPageChartDigestionStatistics } from './qcMergedPageChartDigestionStatistics.js';


/**
 * Constructor 
 */
var QCMergedPageSectionDigestionStatistics = function() {

	//  objects for the charts on the page for this section
	var _pageChartObjectsForSection = [
		qcMergedPageChartDigestionStatistics
	];
...
var qcMergedPageSectionDigestionStatistics = new QCMergedPageSectionDigestionStatistics();

export { qcMergedPageSectionDigestionStatistics }
